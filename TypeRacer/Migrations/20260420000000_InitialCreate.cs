...
namespace TypeRacer.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentenceDifficulty = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    EloGained = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
        ...
        {
            migrationBuilder.DropTable(name: "GameResults");
            migrationBuilder.DropTable(name: "Sentences");
