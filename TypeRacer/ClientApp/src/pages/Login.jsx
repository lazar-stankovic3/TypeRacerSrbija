  ...
  return (
    <div className="page">
      <div className="topbar">
        ...
        <span style={{ color: 'var(--text-2)', fontSize: '0.9rem', fontWeight: 600 }}>Prijava</span>
      </div>

      <div className="menu-card">
        <h2 style={{ fontSize: '1.3rem', fontWeight: 800, marginBottom: '1.5rem' }}>Prijavite se</h2>
        ...
        <p style={{ textAlign: 'center', marginTop: '1rem', color: 'var(--text-3)', fontSize: '0.85rem' }}>
          Nemate nalog? <Link to="/register" style={{ color: 'var(--primary)' }}>Registrujte se</Link>
        </p>
      </div>
    </div>
  )
